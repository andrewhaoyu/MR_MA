...
write.table(out_clump_SNP,file = "/data/zhangh24/MR_MA/result/real_data_analysis/HDL/HDL_BC.aligned",row.names = F,col.names = T,quote=F)
...
write.table(out_clump_SNP,file = "/data/zhangh24/MR_MA/result/real_data_analysis/HDL/HDL_BCsub.aligned",row.names = F,col.names = T,quote=F)
