...
times = 50000
library(ggplot2)
cover_ratio <- matrix(0,1,3)
cover_true <- matrix(0,1,3)
cover_epi <- matrix(0,1,3)
p <- list()
temp <- 1
for(i1 in 1:3){
  for(i2 in 1:1){
    load(paste0("./result/simulation/ratio_estimate/ratio_estimate_case2",i1,"_",i2,"_10.Rdata"))
