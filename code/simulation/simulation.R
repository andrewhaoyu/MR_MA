...
IVW_s = function(Y,M,G,beta_M){
  ...
  Meta_result_1 = Meta(coef_vec,var_vec_1)
  coef_est_1 =   Meta_result_1[1]
  sigma_beta_est_1 = Meta_result_1[2]
  ...
  cover = ifelse((beta_M>=coef_low&
                    beta_M<=coef_high),1,0)
  coef_low_1 = coef_est_1-1.96*sqrt(sigma_beta_est_1)
  coef_high_1 = coef_est_1+1.96*sqrt(sigma_beta_est_1)
  cover_1 = ifelse((beta_M>=coef_low_1&
                    beta_M<=coef_high_1),1,0)
  
  return(c(coef_est,cover,sigma_beta_est,
           coef_est_1,cover_1,sigma_beta_est_1))
}
...
IVWs_est1 = rep(0,times)
cover_IVWs_est1 = rep(0,times)
sigma_IVWs1 = rep(0,times)
...
for(i in 1:times){
  ...
  IVWs_est1[i] = IVWs_result[4]
  cover_IVWs_est1[i] = IVWs_result[5]
  sigma_IVWs1 = IVWs_result[6]
...
result1 = list(TwoStage_est,IVW_est,IVWs_est,IVW_est1,IVWs_est1,
               cover_TwoStage_est,cover_IVW_est,
               cover_IVWs_est,cover_IVW_est1,cover_IVWs_est1,
               sigma_TwoStage,sigma_IVW,sigma_IVWs,
               sigma_IVW1,sigma_IVWs1,
...
result3 = list(TwoStage_est,IVW_est,IVWs_est,IVW_est1,IVWs_est1,
               cover_TwoStage_est,cover_IVW_est,
               cover_IVWs_est,cover_IVW_est1,cover_IVWs_est1,
               sigma_TwoStage,sigma_IVW,sigma_IVWs,
               sigma_IVW1,sigma_IVWs1,
